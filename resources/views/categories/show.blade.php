                ...
                <div class="col s12 m6 l4">
                    <div class="card medium">
                        ...
                        <div class="card-reveal">
                            ...
                            <p><i class="material-icons amber-text">account_circle</i><b>Emprendedor: </b><a class="textoAmber">{{ $service->user->name }}</a></p>
                            <p><i class="material-icons amber-text">monetization_on</i><b>Costo: </b>${{ money_format('%.2n', $service->cost) }} MXN</p>
                            <p><i class="material-icons amber-text">location_on</i><b>Ubicación: </b>{{ $service->location }}</p>
                            <p><i class="material-icons amber-text">date_range</i><b>Creado: </b>{{ $service->updated_at->diffForHumans() }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
