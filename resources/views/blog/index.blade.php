                ...
                <div class="col s12 m6 l4">
                    <div class="card medium">
                        ...
                        <div class="card-reveal">
                            <span class="card-title grey-text text-darken-4 textoAmber">{{ $blog->title }}<i class="material-icons right">close</i></span>
                            <p><i class="material-icons textoAmber">date_range</i><b>Creado: </b>{{ $blog->updated_at->diffForHumans() }} por <a class="textoAmber" href="{{ route('users.show', $blog->user->username) }}">{{ $blog->user->name }}</a></p>
